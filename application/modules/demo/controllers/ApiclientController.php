...
//        var_dump($json);
        ...
        $client->setUri('http://tracnghiem.local/demo/apiserver/get');
...
//        exit;
        ...
        $client->setUri('http://tracnghiem.local/demo/apiserver/post');
        $client->setParameterGet(array(
            'id' => 10
        ));  
         ...
         */
        $client->setUri('http://tracnghiem.local/demo/apiserver/delete');
...
//            'id' => 1000
//        ));
        $client->setUri('http://tracnghiem.local/demo/apiserver/put');
